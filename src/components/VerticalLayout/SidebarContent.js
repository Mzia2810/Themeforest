      ...
      <SimpleBar className="h-100" ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li className="menu-title">{props.t("Reports and Search")}</li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/ecommerce-products">{props.t("Search by Skills")}</Link>
                </li>
                <li>
                  <Link to="/tables-datatable">{props.t("Search by Employee")}</Link>
                </li>
                {/* <li>
